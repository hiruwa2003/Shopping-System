    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50">
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="flex flex-col md:flex-row w-full max-w-6xl bg-white/80 backdrop-blur-lg rounded-3xl overflow-hidden shadow-2xl transform transition-all duration-500 hover:shadow-3xl">
          ...
          <div className="md:w-1/2 bg-gradient-to-br from-orange-500 to-orange-600 p-8 md:p-12 relative overflow-hidden transform transition-transform duration-500 hover:scale-[1.02]">
            ...
            <div className="relative z-10 text-white text-center h-full flex flex-col justify-center items-center">
              <div className="mb-8 transform transition-transform duration-500 hover:scale-105">
                ...
                <h2 className="text-4xl font-semibold mb-4 bg-gradient-to-r from-white to-orange-100 bg-clip-text text-transparent">
                  BUYING PROBLEMS
                </h2>
            ...
            >
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="relative">
                      <input
                        ...
                        className="peer w-full px-4 py-3 bg-white/50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300 hover:border-blue-400"
                        required
                      />
                      <label 
                        htmlFor="firstName"
                        className="absolute left-4 top-3 text-gray-500 transition-all duration-300 peer-focus:text-blue-600 peer-focus:-top-2 peer-focus:text-sm peer-[&:not(:placeholder-shown)]:-top-2 peer-[&:not(:placeholder-shown)]:text-sm bg-white px-1"
                      >
                        First Name
                      </label>
                    </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:-translate-y-1 active:translate-y-0 shadow-lg hover:shadow-2xl relative overflow-hidden group"
                  >
                ...
                <div className="mt-8 text-center">
                  <p className="text-gray-600">
                    ...
                    <Link
                      to="/signin"
                      className="text-blue-600 font-semibold hover:text-blue-700 transition-colors duration-300 relative group"
                    >
                      Sign In
